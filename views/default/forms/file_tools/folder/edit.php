...
if (!empty($folder)) {
	...
	$form_data = elgg_view("input/hidden", array(
		"name" => "guid",
...
$form_data .= elgg_view("input/longtext", array(
	"name" => "description",
	"value" => $desc
));
$form_data .= "</div>";
...
$form_data .= "<br />";
$form_data .= elgg_view("input/folder_select", array(
...
$form_data .= "<br />";
$form_data .= elgg_view("input/access", array(
	"name" => "access_id",
	"value" => $access_id
));
$form_data .= "</div>";
...
if (!empty($folder)) {
	...
	$form_data .= "<div>" . elgg_view("input/checkboxes", array(
			"options" => array(elgg_echo("file_tools:forms:edit:change_children_access") => "yes"),
			"value" => "yes",
			"name" => "change_children_access"
		)) . "</div>";
	$form_data .= "<div>" . elgg_view("input/checkboxes", array(
			"options" => array(elgg_echo("file_tools:forms:edit:change_files_access") => "yes"),
